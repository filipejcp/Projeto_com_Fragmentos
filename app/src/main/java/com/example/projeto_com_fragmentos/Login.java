...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String password=password_field.getText().toString();
                ...
                //String url = "http://localhost/PM/contatos/public/api/user/" + nome +"/" + password;
                String url = "http://172.16.184.229/PM/contatos/public/api/user/teste/teste";
                ...
                editor.putString("NAME", "teste");
                editor.putString("PASSWORD", "teste");
